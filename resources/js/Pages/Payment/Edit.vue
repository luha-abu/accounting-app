...
const submit = () => {
    ...
    form.put(route('payments.update', props.sale.id), {
        onError: (errors) => {
    ...
    <AppLayout title="Create Payment">
        <nav class="navbar shadow-sm bg-body-tertiary">
            <div class="container-fluid">
                <div class="left-bar">
                    <span class="navbar-brand mb-0 h1 py-0"><Link :href="route('payments.index')" class="btn btn-link"><i class="bi bi-chevron-left"></i></Link>Modify Payment</span>
                </div>
            </div>
        </nav>
